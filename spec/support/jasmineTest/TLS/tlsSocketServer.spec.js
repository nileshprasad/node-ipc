...
describe('Test Cases for TLS server: ',
         function(){
                                ...
                                function connected(socket){
                                    ...
                                    ipc.server.on(
                                        ...
                                        function gotMessage(data,socket){
                                            //console.log('data obtained from TLS Client is: ', data.id, data.message);
                                            responseMessage[data.id]=true;

                                            if (data.id == 'tlsClientTest1'){
                                                expect(data.message).toBe('Acknowledgement from client1.');
                                            }
                                            else if (data.id == 'tlsClientTest2'){
